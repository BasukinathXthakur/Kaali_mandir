...
export const TRANSLATIONS = {
  ...
  [LANGUAGES.MAITHILI]: {
    ...
    // Auth page
    loginToYourAccount: "अपन खाता म लॉगिन करू",
    createAnAccount: "खाता बनाऊ",
    fullName: "पूरा नाम",
    yourName: "आपक नाम",
    emailAddress: "ईमेल पता",
    yourEmail: "आपक ईमेल",
    ...
    yourPhone: "आपक फोन",
    password: "पासवर्ड",
    yourPassword: "आपक पासवर्ड",
    login: "लॉगिन",
    register: "रजिस्टर",
    needAnAccount: "खाता चाही? रजिस्टर करू",
    alreadyHaveAccount: "पहिले स खाता छै? लॉगिन करू",
    authenticationFailed: "प्रमाणीकरण विफल। कृपया पुनः प्रयास करू।",
    enterSacredSpace: "काली मंदिर के पवित्र जगह म प्रवेश करू",
    joinDivineCommunity: "हमर दिव्य भक्त समुदाय म शामिल होऊ",
    processing: "प्रसंस्करण...",
    divineBlessings: "आपक साथ दिव्य आशीर्वाद हो",
  },
};
