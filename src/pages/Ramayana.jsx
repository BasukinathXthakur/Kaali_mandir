...
const Ramayana = () => {
  ...
  const downloadPDF = () => {
    ...
    link.href = "/(000)-FULL-Ramcharitmans-with-Index.pdf";
    link.download = "Ramcharitmans.pdf";
    link.click();
  };
      ...
      >
        ...
        {!isFullscreen && (
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 mb-6">
              The Divine Journey of Lord Rama - Complete Text
            </p>
        ...
        >
          <div className="flex justify-center">
            <iframe
              src="/(000)-FULL-Ramcharitmans-with-Index.pdf#toolbar=1&navpanes=1&scrollbar=1"
              width="100%"
