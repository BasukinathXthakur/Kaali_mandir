...
import { FaCalendarAlt, FaRupeeSign, FaUsers, FaChartLine } from 'react-icons/fa';
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="mt-4">
                  <Link to="/admin/events" className="text-orange-500 hover:text-orange-600 text-sm font-medium">
                    View all events →
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="mt-4">
                  <Link to="/admin/events" className="text-green-500 hover:text-green-600 text-sm font-medium">
                    Manage events →
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-gray-800">₹{stats.totalDonations.toLocaleString()}</h3>
                  </div>
                </div>
                <div className="mt-4">
                  <Link to="/admin/donations" className="text-blue-500 hover:text-blue-600 text-sm font-medium">
                    View donations →
                  </Link>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    {upcomingEvents.map((event) => (
                      <div key={event.id} className="flex items-center p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                        ...
                        <Link to={`/admin/events?edit=${event.id}`} className="text-blue-500 hover:text-blue-600 text-sm">
                          Edit
                        </Link>
                      </div>
                    ))}
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Link to="/admin/donations" className="text-orange-500 hover:text-orange-600 text-sm font-medium">
                    View All
                  </Link>
                </div>
                ...
                {recentDonations.length > 0 ? (
                  <div className="space-y-4">
                    {recentDonations.map((donation) => (
                      <div key={donation.id} className="flex items-center p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                        <div className="p-2 rounded-md bg-green-100 text-green-500 mr-4">
                          <FaRupeeSign />
                        </div>
                        <div className="flex-grow">
                          <h3 className="text-gray-800 font-medium">{donation.name}</h3>
                          <p className="text-gray-500 text-sm">{formatDate(donation.timestamp)}</p>
                        </div>
